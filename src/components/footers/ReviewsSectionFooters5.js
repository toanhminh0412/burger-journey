...
export default function ReviewsSectionFooters5() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container px-4 mx-auto">
      ...
      <div className="flex flex-wrap -m-8">
        ...
        <div className="w-full sm:w-1/2 lg:w-4/12 p-8">
          <div className="lg:max-w-sm">
            ...
            <p className="mb-5 font-sans text-gray-600 leading-relaxed">Subscribe to our email to receive notifications about our food and drink offerings</p>
            <div className="mb-3 xl:pl-6 inline-block md:max-w-xl w-full overflow-hidden border border-gray-300 rounded-xl focus-within:ring focus-within:ring-indigo-300">
              <div className="flex flex-wrap items-center">
                <div className="w-full xl:flex-1">
                  <input className="p-3 xl:p-0 xl:pr-6 w-full font-medium text-gray-500 placeholder-gray-500 outline-none" id="footerInput1-1" type="text" placeholder="Type your e-mail" />
                </div>
                <div className="w-full xl:w-auto">
                  <div className="block">
                    <button className="py-4 px-8 w-full text-white font-semibold border border-indigo-700 focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200" type="button">Subscribe</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="flex flex-wrap justify-between items-center py-6 -m-4">
      <div className="w-auto p-4">
        <a href="#">
          <img src="https://static.shuffle.dev/uploads/files/09/0962887a9ccc9b46989b140868d64a44538f3648/logo.webp" alt="" className="w-14" />
        </a>
      </div>
      <div className="w-auto p-4">
        <p className="text-sm text-gray-600 font-medium">Copyright © 2024 Burger Journey. All Rights Reserved</p>
      </div>
      <div className="w-auto p-4">
